...
PARAM$trainingstrategy$semilla_azar   <- 328789  #Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 820679  #Aqui poner su segunda semilla
...
#defino el método estandar para la creacion de los puntos iniciales, los "No Inteligentes"
