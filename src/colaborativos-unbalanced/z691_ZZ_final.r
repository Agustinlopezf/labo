...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910_unbalanced"
PARAM$exp_input  <- "HT6510_unbalanced"

PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 328789  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde
